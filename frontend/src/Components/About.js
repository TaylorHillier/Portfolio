...
function AboutPage({ apiUrl }) {
  ...
  return (
      ...
      <section className='relative z-10 bg-gradient-to-b from-[#151d1f] via-[#0a0a19] to-[#70828F] text-white w-full'>
        ...
        <img src={aboutFields.acf && aboutFields.acf.portrait} loading="lazy" alt="Photo of myself - Taylor Hillier" width='768px' height='100%' className='max-h-screen max-w-full object-cover object-center md:w-1/2'/>
