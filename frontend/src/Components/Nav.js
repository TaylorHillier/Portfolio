...
function Nav() {
  ...
  return (
    <nav
      className={` md:flex md:justify-evenly text-white  min-h-20 ${
    ...
    >
      <ul className='md:flex md:justify-evenly text-white grid grid-cols-3 justify-items-center'>
        <li className='p-4 text-sm font-thin w-full hover:scale-110 hover:bg-[#0a0a19]' >
        ...
        <li className='text-sm font-thin w-full hover:scale-110 p-4  hover:bg-[#0a0a19]'>
